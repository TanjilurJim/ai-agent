            ...
            <div class="row align-items-center">
                <div class="col-xl-6 col-8">
                    <div class="sidebar-logo">
                        <a href="#"><img src="assets/img/logo-ai.png" alt="logo-img"></a>
                    </div>
                </div>
                            ...
                            <div class="row align-items-center justify-content-between">
                                <div class="col-xl-2 col-lg-2 col-6 ">
                                    <div class="header-logo">
                                        <a href="#"><img src="{{asset('frontend/assets/img/ai agent logo.svg')}}" alt="Image Not Found"></a>
                                    </div>
                                </div>
                        ...
                        <div class="container custom-container-1">
                            <div class="banner-single">
                                <div class="banner-content">
                                    ...
                                    <h1 class="banner-content-title tp_has_text_reveal_anim">Best Ai-agent for Customer Service</h1>
                                    <p class="tp_desc_anim">An all-in-one platform to build and launch chatbots conversational <br> without coding.Powered by advanced AI, it enables businesses to automate customer interactions, enhance user engagement, and provide real-time support across multiple channels.</p>
                                ...
                                <div class="banner-img tp_fade_left">
                                    <img src="{{asset('frontend/assets/images/banner/home1/bg.png')}}" alt="Image Not Found">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xl-3 col-lg-4 col-md-6 tp_fade_left" data-fade-from="left">
                                    <div class="choose-item mb-30">
                                        ...
                                        <div class="choose-item-img">
                                            <img src="{{asset('frontend/assets/images/choose/1.png')}}" alt="Image Not Found">
                                        </div>
                                        <div class="choose-item-content">
                                            <h5 class="choose-item-content-title"><a href="#">Fast response</a></h5>
                                            <p>Our AI-powered platform ensures lightning-fast responses, allowing chatbots to instantly understand queries and provide accurate answers in real time. </p>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 tp_fade_left" data-fade-from="left" data-delay=".8">
                                    <div class="choose-item mb-30">
                                        ...
                                        <div class="choose-item-img">
                                            <img src="{{asset('frontend/assets/images/choose/2.png')}}" alt="Image Not Found">
                                        </div>
                                        <div class="choose-item-content">
                                            <h5 class="choose-item-content-title"><a href="#">customize widget</a></h5>
                                            <p>Easily design and integrate customized widgets to match your brand, enhance user experience, and provide seamless chatbot interactions.</p>
                                            <a href="#" class="choose-item-content-btn">Learn More<i class="fa-light fa-angle-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-4 col-md-6 tp_fade_left" data-fade-from="left" data-delay="1.1">
                                    <div class="choose-item mb-30">
                                        ...
                                        <div class="choose-item-img">
                                            <img src="{{asset('frontend/assets/images/choose/3.png')}}" alt="Image Not Found">
                                        </div>
                                        <div class="choose-item-content">
                                            <h5 class="choose-item-content-title"><a href="#">All Language...</a></h5>
                                            <p>Support for multiple languages enables seamless communication, allowing chatbots to engage users worldwide in their preferred language.</p>
                                            <a href="#" class="choose-item-content-btn">Learn More<i class="fa-light fa-angle-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                                  <div class="col-xl-3 col-lg-4 col-md-6 tp_fade_left" data-fade-from="left" data-delay="1.3">
                                    <div class="choose-item mb-30">
                                        ...
                                        <div class="choose-item-img">
                                            <img src="{{asset('frontend/assets/images/choose/4.png')}}" alt="Image Not Found">
                                        </div>
                                        <div class="choose-item-content">
                                            <h5 class="choose-item-content-title"><a href="#">24/7 Hours Support</a></h5>
                                            <p>Ensure uninterrupted assistance with 24/7 AI-powered support, providing instant responses and seamless user interactions anytime, anywhere.</p>
                                            <a href="#" class="choose-item-content-btn">Learn More<i class="fa-light fa-angle-right"></i></a>
                                        </div>
                                    </div>
                                </div> 
                        ...
                        <div class="container">
                            ...
                            <div class="feature-top mb-50 tp_fade_bottom">
                                <div class="feature-item feature-item-1">
                                    ...
                                    <p>Train your chatbot effortlessly with a user-friendly interface, enabling quick learning and adaptation without any coding.</p>
                                </div>
                                <div class="feature-item feature-item-2">
                                    <h5 class="feature-item-title">Single page chating</h5>
                                    <p>Enjoy seamless conversations with a single-page chatting interface, ensuring fast, uninterrupted, and user-friendly interactions.</p>
                                </div>
                                <div class="feature-item feature-item-3">
                                    <h5 class="feature-item-title">In-enhance result</h5>
                                    <p>Get instant, in-hand results with real-time processing, ensuring fast and accurate responses for a seamless user experience</p>
                                </div>
                            </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-xl-7 col-lg-8">
                                    <div class="section-area text-center">
                                        ...
                                        <h2 class="section-title tp_title_slideup mb-0">Ai-agent  4.8/5 Stars in Over 10,000+ Reviews.</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="swiper-wrapper roll-slider">
                                    ...
                                    <div class="testimonial-item">
                                        ...
                                        <div class="testimonial-head">
                                            <div class="testimonial-head-img">
                                                <img src="{{asset('frontend/assets/images/testimonial/1.png')}}" alt="Image Not Found">
                                            </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        ...
                                        <div class="testimonial-head">
                                            <div class="testimonial-head-img">
                                                <img src="{{asset('frontend/assets/images/testimonial/2.png')}}" alt="Image Not Found">
                                            </div>
                                            <div class="testimonial-head-info">
                                                <h6>Nigel Nigel</h6>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        ...
                                        <div class="testimonial-head">
                                            <div class="testimonial-head-img">
                                                <img src="{{asset('frontend/assets/images/testimonial/3.png')}}" alt="Image Not Found">
                                            </div>
                                            <div class="testimonial-head-info">
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        ...
                                        <div class="testimonial-head">
                                            <div class="testimonial-head-img">
                                                <img src="{{asset('frontend/assets/images/testimonial/4.png')}}" alt="Image Not Found">
                                            </div>
                                            <div class="testimonial-head-info">
                            ...
                            <div class="swiper-wrapper roll-slider">
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        ...
                                        <div class="testimonial-head">
                                            <div class="testimonial-head-img">
                                                <img src="{{asset('frontend/assets/images/testimonial/5.png')}}" alt="Image Not Found">
                                            </div>
                                            <div class="testimonial-head-info">
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        ...
                                        <div class="testimonial-head">
                                            <div class="testimonial-head-img">
                                                <img src="{{asset('frontend/assets/images/testimonial/6.png')}}" alt="Image Not Found">
                                            </div>
                                            <div class="testimonial-head-info">
                                                <h6>Hanson Deck</h6>
                                                <span>Blogger</span>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        ...
                                        <div class="testimonial-head">
                                            <div class="testimonial-head-img">
                                                <img src="{{asset('frontend/assets/images/testimonial/7.png')}}" alt="Image Not Found">
                                            </div>
                                            <div class="testimonial-head-info">
                                                <h6>Nathaneal Down</h6>
                                                <span>Blogger</span>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        ...
                                        <div class="testimonial-head">
                                            <div class="testimonial-head-img">
                                                <img src="{{asset('frontend/assets/images/testimonial/8.png')}}" alt="Image Not Found">
                                            </div>
                                            <div class="testimonial-head-info">
                                                <h6>Russell Sprout</h6>
                                                <span>Blog Writer</span>
